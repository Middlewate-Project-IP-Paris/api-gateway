...
from proto.assitant import assistant_on_demand_pb2 as proto_dot_assitant_dot_assistant__on__demand__pb2
...
class assistanceOnDemandStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getChannelMeta = channel.unary_unary(
                ...
                request_serializer=proto_dot_assitant_dot_assistant__on__demand__pb2.ChannelMetaRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.getPostStat = channel.unary_unary(
                '/assistant_on_demand.assistanceOnDemand/getPostStat',
                request_serializer=proto_dot_assitant_dot_assistant__on__demand__pb2.PostStatRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.getChannelSubs = channel.unary_unary(
                '/assistant_on_demand.assistanceOnDemand/getChannelSubs',
                request_serializer=proto_dot_assitant_dot_assistant__on__demand__pb2.ChannelSubsRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.getPost = channel.unary_unary(
                '/assistant_on_demand.assistanceOnDemand/getPost',
                request_serializer=proto_dot_assitant_dot_assistant__on__demand__pb2.PostRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.joinChannel = channel.unary_unary(
                '/assistant_on_demand.assistanceOnDemand/joinChannel',
                request_serializer=proto_dot_assitant_dot_assistant__on__demand__pb2.InviteRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
...
def add_assistanceOnDemandServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getChannelMeta': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_assitant_dot_assistant__on__demand__pb2.ChannelMetaRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'getPostStat': grpc.unary_unary_rpc_method_handler(
                    servicer.getPostStat,
                    request_deserializer=proto_dot_assitant_dot_assistant__on__demand__pb2.PostStatRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'getChannelSubs': grpc.unary_unary_rpc_method_handler(
                    servicer.getChannelSubs,
                    request_deserializer=proto_dot_assitant_dot_assistant__on__demand__pb2.ChannelSubsRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'getPost': grpc.unary_unary_rpc_method_handler(
                    servicer.getPost,
                    request_deserializer=proto_dot_assitant_dot_assistant__on__demand__pb2.PostRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'joinChannel': grpc.unary_unary_rpc_method_handler(
                    servicer.joinChannel,
                    request_deserializer=proto_dot_assitant_dot_assistant__on__demand__pb2.InviteRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
    }
...
class assistanceOnDemand(object):
    ...
    def getChannelMeta(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/assistant_on_demand.assistanceOnDemand/getChannelMeta',
            proto_dot_assitant_dot_assistant__on__demand__pb2.ChannelMetaRequest.SerializeToString,
    ...
    def getPostStat(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/assistant_on_demand.assistanceOnDemand/getPostStat',
            proto_dot_assitant_dot_assistant__on__demand__pb2.PostStatRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getChannelSubs(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/assistant_on_demand.assistanceOnDemand/getChannelSubs',
            proto_dot_assitant_dot_assistant__on__demand__pb2.ChannelSubsRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getPost(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/assistant_on_demand.assistanceOnDemand/getPost',
            proto_dot_assitant_dot_assistant__on__demand__pb2.PostRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def joinChannel(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/assistant_on_demand.assistanceOnDemand/joinChannel',
            proto_dot_assitant_dot_assistant__on__demand__pb2.InviteRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
